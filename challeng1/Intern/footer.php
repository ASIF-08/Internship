<footer class="container">
    ...
    <p>copyright© 2020–2021 First Blog, Inc. · <a href="#">Privacy</a> · <a href="#">Terms</a></p>
    ...
    <footer class="bd-footer p-2 p-md-2 mt-2 bg-light text-center text-sm-left">
  <div class="container">
  <ul class="bd-footer-links list-inline" >
      <li class="list-inline-item" ><a href="https://github.com/twbs">GitHub</a></li>
      <li class="list-inline-item"><a href="index.php">Home</a></li>
    </ul>
    <p>Internship . © 2021 First Sample Website, Inc.   </p>
  </div>
</footer>
  </footer>